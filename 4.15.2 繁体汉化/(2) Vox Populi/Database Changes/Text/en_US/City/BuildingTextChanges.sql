...
-- 研發實驗室
UPDATE Language_ZH_HANT_HK
SET Text = '此城市的[ICON_RES_OIL]石油, [ICON_RES_ALUMINUM]鋁材, [ICON_RES_URANIUM]鈾, 學院 +4 [ICON_RESEARCH]科學.[NEWLINE][NEWLINE]醫院, 工廠, 研發實驗室 +4 [ICON_RESEARCH]科學, 同時此城市[ICON_GREAT_SCIENTIST]大科學家誕生速度加快 33%.[NEWLINE][NEWLINE]-1 來自[ICON_RESEARCH]文盲的[ICON_HAPPINESS_3]不滿度.'
