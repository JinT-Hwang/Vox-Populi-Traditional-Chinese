...
SET Text = '城市每 3 [ICON_CITIZEN]公民 +1 [ICON_RESEARCH]科學. 包含 1 個藝術[ICON_GREAT_WORK]巨作或文物的席位.此城市 1 專家不再產生來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE]當下列[COLOR_POSITIVE_TEXT]歷史事件[ENDCOLOR]之一完成時, 根據您最近的 [ICON_CULTURE]文化和 [ICON_TOURISM]旅遊業績輸出,提升與所有已知的文明的[ICON_TOURISM]旅遊業績:[NEWLINE][ICON_BULLET]獲得一個[ICON_GREAT_PEOPLE]偉人[NEWLINE][ICON_BULLET]建造一個[ICON_GOLDEN_AGE]世界奇跡[NEWLINE][ICON_BULLET]贏得一場[ICON_WAR]戰爭 (戰爭分數 25+)[NEWLINE][ICON_BULLET]進入一個新[ICON_RESEARCH]時代[NEWLINE][NEWLINE][ICON_CAPITAL]首都通過道路[ICON_CONNECTED]連接其他城市會產生額外[ICON_GOLD]金幣.'
WHERE Tag = 'TXT_KEY_BUILDING_PALACE_HELP';

-- Granary
UPDATE Language_en_US
SET Text = '完成時 +25 [ICON_FOOD]食物.新[ICON_CITIZEN]公民誕生后 15% of [ICON_FOOD]食物會保留.[NEWLINE][NEWLINE]允許這個城市的[ICON_FOOD]食物通過國内貿易路綫流動.[NEWLINE][NEWLINE]附近[ICON_RES_WHEAT]小麥: +1 [ICON_FOOD]食物.[NEWLINE]附近[ICON_RES_MAIZE]玉米: +1 [ICON_FOOD]食物.[NEWLINE]附近[ICON_RES_RICE]稻米: +1 [ICON_FOOD]食物.[NEWLINE]附近[ICON_RES_BANANA]香蕉: +1 [ICON_FOOD]食物.'
...
-- Aqueduct
UPDATE Language_en_US
SET Text = '新[ICON_CITIZEN]公民誕生後,[ICON_FOOD]食物的 15% 會保留,而[ICON_PRODUCTION]產能的 25% 會加入城市當前[ICON_PRODUCTION]產能.此城市的湖和綠洲 +2 [ICON_FOOD]食物.[NEWLINE][NEWLINE][ICON_GOLD]貧窮 -1 [ICON_HAPPINESS_3]不滿.'
...
-- Garden
UPDATE Language_en_US
SET Text = '此城市 +25% [ICON_GREAT_PEOPLE]偉人誕生速度.[NEWLINE][NEWLINE]此城市 1 專家不再產生來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE]附近綠洲: +2 [ICON_GOLD]金幣.[NEWLINE]附近[ICON_RES_CITRUS]柑橘: +1 [ICON_FOOD]食物, +1 [ICON_GOLD]金幣.[NEWLINE]附近[ICON_RES_COCOA]可可: +1 [ICON_FOOD]食物, +1 [ICON_GOLD]金幣.[NEWLINE]附近[ICON_RES_CLOVES]丁香: +1 [ICON_PEACE]信仰, +1 [ICON_CULTURE]文化.[NEWLINE]附近[ICON_RES_PEPPER]胡椒: +1 [ICON_PEACE]信仰, +1 [ICON_GOLD]金幣.[NEWLINE]附近[ICON_RES_NUTMEG]肉豆蔻: +1 [ICON_CULTURE]文化, +1 [ICON_PRODUCTION]產能.'
...
-- 廣播塔
UPDATE Language_en_US
SET Text = '城市每 2 [ICON_CITIZEN]公民 +1 [ICON_CULTURE]文化和[ICON_TOURISM]旅遊業績. 此城市[ICON_GREAT_WORK]巨作產生 +2 [ICON_TOURISM]旅遊業績.[NEWLINE][NEWLINE]-1 來自文化乏味的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE]如果[COLOR_POSITIVE_TEXT]主題獎勵已啟動[ENDCOLOR] +10 [ICON_GOLD]金幣.'
...
--軍營
UPDATE Language_en_US
SET Text = '+15 經驗給所有單位. +1 [ICON_WAR]軍事單位供應上限.[NEWLINE][NEWLINE]-1 來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫的[ICON_HAPPINESS_3]不滿.'
WHERE Tag = 'TXT_KEY_BUILDING_BARRACKS_HELP';

-- Armory
UPDATE Language_en_US
SET Text = '+20 經驗給所有單位. +1 [ICON_WAR]軍事單位供應上限.[NEWLINE][NEWLINE]-1 來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫的[ICON_HAPPINESS_3]不滿.'
WHERE Tag = 'TXT_KEY_BUILDING_ARMORY_HELP';

-- Military Academy
UPDATE Language_en_US
SET Text = '+15% 陸地單位[ICON_PRODUCTION]產能, +25 經驗給所有單位. +1 [ICON_WAR]軍事單位供應上限.[NEWLINE][NEWLINE]-1 來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫的[ICON_HAPPINESS_3]不滿.'
...
UPDATE Language_en_US
SET Text = '建造石工作坊需要城市附近至少有一個[ICON_RES_STONE]石材, [ICON_RES_MARBLE]大理石, [ICON_RES_SALT]食鹽, [ICON_RES_JADE]玉, [ICON_RES_AMBER]琥珀, [ICON_RES_LAPIS]青金石, 或者[ICON_RES_URANIUM]鈾資源被改良. 石工作坊增加 [ICON_PRODUCTION]產能 同時允許此城市的[ICON_PRODUCTION]產能通過國内貿易路綫流動.'
...
UPDATE Language_en_US
SET Text = '進來的[ICON_ARROW_LEFT]貿易路綫產出 +2 [ICON_GOLD]金幣給此城市, 同時 +2 [ICON_GOLD]金幣給[ICON_ARROW_RIGHT]貿易路綫的擁有者.[NEWLINE][NEWLINE]-1 來自[ICON_GOLD]貧窮的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE]附近[ICON_RES_BANANA]香蕉: +2 [ICON_GOLD]金幣.[NEWLINE]附近[ICON_RES_COFFEE]咖啡: +1 [ICON_GOLD]金幣, +2 [ICON_PRODUCTION]產能.[NEWLINE]附近[ICON_RES_TEA]茶: +2 [ICON_GOLD]金幣, +1 [ICON_PRODUCTION]產能.[NEWLINE]附近[ICON_RES_TOBACCO]烟草: +3 [ICON_GOLD]金幣.'
...
--圖書館
UPDATE Language_en_US
SET Text = '-1 來自[ICON_RESEARCH]文盲的[ICON_HAPPINESS_3]不滿. 此城市 1 專家不再產生來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿.'
WHERE Tag = 'TXT_KEY_BUILDING_LIBRARY_HELP';

-- University
UPDATE Language_en_US
SET Text = '此城市的叢林和雪地單元格 +1 [ICON_RESEARCH]科學. 此城市[ICON_CITIZEN]公民誕生時, 獲得 25% 城市[ICON_RESEARCH]科學產出立即提升您目前的研究.[NEWLINE][NEWLINE]-1 來自[ICON_RESEARCH]文盲的[ICON_HAPPINESS_3]不滿.'
...
-- Public School
UPDATE Language_en_US
SET Text = '城市每 2 [ICON_CITIZEN]公民 +1 [ICON_RESEARCH]科學.[NEWLINE][NEWLINE]-1 來自[ICON_RESEARCH]文盲的[ICON_HAPPINESS_3]不滿.'
...
-- 研發實驗室
UPDATE Language_en_US
SET Text = '此城市的[ICON_RES_OIL]石油, [ICON_RES_ALUMINUM]鋁材, [ICON_RES_URANIUM]鈾, 學院 +4 [ICON_RESEARCH]科學.[NEWLINE][NEWLINE]醫院, 工廠, 研發實驗室 +4 [ICON_RESEARCH]科學, 同時此城市[ICON_GREAT_SCIENTIST]大科學家誕生速度加快 33%.[NEWLINE][NEWLINE]-1 來自[ICON_RESEARCH]文盲的[ICON_HAPPINESS_3]不滿.'
...
UPDATE Language_en_US
SET Text = '所有城市的[ICON_PRODUCTION]產能轉換效率提高 10%.[NEWLINE][NEWLINE]此城市 +25% [ICON_GREAT_PEOPLE]偉人誕生速度, 同時所有專家 +1 [ICON_PRODUCTION]產能, [ICON_GOLD]金幣, [ICON_RESEARCH]科學,[ICON_CULTURE]文化.[NEWLINE][NEWLINE]需要 1 [ICON_RES_URANIUM]鈾才能建造. 城市不能有其他能源生產工廠.'
...
-- Courthouse
UPDATE Language_en_US
SET Text = '消除[ICON_OCCUPIED]占領的城市的額外[ICON_HAPPINESS_4]不滿. 成本根據您帝國中的城市數量而增加.'
...
-- Military Base
UPDATE Language_en_US
SET Text = '+25% 空軍單位[ICON_PRODUCTION]產能, 空軍單位空襲城市 +15 [ICON_STRENGTH]傷害. +10% 城市的[ICON_RANGE_STRENGTH]遠程攻擊傷害. +20% 來自人口的[ICON_SILVER_FIST]軍事單位供應上限, 同時此城市的駐軍單位多加 20 生命治療.[NEWLINE][NEWLINE]-1 來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫的[ICON_HAPPINESS_3]不滿. [ICON_CITY_STATE]此城市帝國人口修正減少 5%.'
...
-- Factory
UPDATE Language_en_US
SET Text = '城市中每 4 [ICON_CITIZEN]公民 +1 [ICON_PRODUCTION]產能.製造廠 +2 [ICON_PRODUCTION]產能, 所有工廠 +2 [ICON_PRODUCTION]產能.[NEWLINE][NEWLINE]此城市 1 專家不再產生來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE]附近[ICON_RES_COAL]煤礦: +2 [ICON_PRODUCTION]產能, +2 [ICON_RESEARCH]科學.[NEWLINE][NEWLINE]需要 1 [ICON_RES_COAL]煤礦. '
...
-- Circus
UPDATE Language_en_US
SET Text = '完成時 +100 [ICON_CULTURE]文化, 城市開始 10 回合的"敬王之日".[NEWLINE][NEWLINE]-1 來自[ICON_CULTURE]文化乏味的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE]附近[ICON_RES_IVORY]象牙: +3 [ICON_CULTURE]文化.'
WHERE Tag = 'TXT_KEY_BUILDING_CIRCUS_HELP';

UPDATE Language_en_US
SET Text = '馬戲場減少城市的文化乏味和提升[ICON_RES_IVORY]象牙的文化產出. 同時開始 10 回合的"敬王之日". 建造它來消除文化乏味的不滿和獲得快速迸發的文化.'
...
UPDATE Language_en_US
SET Text = '競技場提供額外的文化和生成來自城市人口的旅遊業績. 減少城市的文化乏味和提高附近[ICON_RES_PERFUME]香水和[ICON_RES_OLIVE]橄欖的產出. 建造它來消除來自文化乏味的不滿, 來增加你的文化,和來提高您的軍事建築的產能.'
...
-- Zoo
UPDATE Language_en_US
SET Text = '完成時 +500 [ICON_RESEARCH]科學. 附近叢林和森林單元格獲得 +1 [ICON_CULTURE]文化和[ICON_TOURISM]旅遊業績.[NEWLINE][NEWLINE]完成一條從這出發到達其他文明的[ICON_CARAVAN]/[ICON_CARGO_SHIP]貿易路綫, 會觸發一個(或者增强現有的一個)[COLOR_POSITIVE_TEXT]歷史事件[ENDCOLOR].[NEWLINE][NEWLINE]-1 來自[ICON_CULTURE]文化乏味的[ICON_HAPPINESS_3]不滿.'
...
-- Police Station
UPDATE Language_en_US
SET Text = '+10 [ICON_SPY]城市安保, 城市每 2 [ICON_CITIZEN]公民 +1.[NEWLINE][NEWLINE]-1 來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫, [ICON_GOLD]貧窮, [ICON_RESEARCH]文盲,和[ICON_CULTURE]文化乏味的[ICON_HAPPINESS_3]不滿.'
WHERE Tag = 'TXT_KEY_BUILDING_POLICE_STATION_HELP';

-- Constabulary
UPDATE Language_en_US
SET Text = '+20 [ICON_SPY]城市安保, 城市每 2 [ICON_CITIZEN]公民 +1.[NEWLINE][NEWLINE]-1 來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫的[ICON_HAPPINESS_3]不滿.'
...
--音樂家' Guild
UPDATE Language_en_US
SET Text = '提供 5 [ICON_GREAT_PEOPLE]偉人點數 (GPP) 給一個[ICON_GREAT_MUSICIAN]大音樂家. 增加到 2 專家給這個建築以獲得[ICON_CULTURE]文化和增加[ICON_GREAT_MUSICIAN]大音樂家誕生速度.[NEWLINE][NEWLINE]此城市 1 專家不再產生來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE]帝國内最多 3 個這些建築.'
WHERE Tag = 'TXT_KEY_BUILDING_MUSICIANS_GUILD_HELP';

--藝術家' Guild
UPDATE Language_en_US
SET Text = '提供 4 [ICON_GREAT_PEOPLE]偉人點數 (GPP) 給一個[ICON_GREAT_ARTIST]大藝術家. 增加到 2 專家給這個建築以獲得[ICON_CULTURE]文化和增加誕生速度[ICON_GREAT_ARTIST]大藝術家.[NEWLINE][NEWLINE]此城市 1 專家不再產生來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE]帝國内最多 3 個這些建築.'
WHERE Tag = 'TXT_KEY_BUILDING_ARTISTS_GUILD_HELP';

--作家' Guild
UPDATE Language_en_US
SET Text = '提供 3 [ICON_GREAT_PEOPLE]偉人點數 (GPP) 給一個[ICON_GREAT_WRITER]大作家. 增加到 2 專家給這個建築以獲得[ICON_CULTURE]文化和增加誕生速度[ICON_GREAT_WRITER]大作家.[NEWLINE][NEWLINE]此城市 1 專家不再產生來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE]帝國内最多 3 個這些建築.'
...
UPDATE Language_en_US
SET Text = '此城市[ICON_GOLDEN_AGE]黃金時代期間 +20% [ICON_RESEARCH]科學. 此城市 1 專家不再產生來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿. 包含 1 文學[ICON_GREAT_WORK]巨作席位.[NEWLINE][NEWLINE]所有城市 -1 來自[ICON_RESEARCH]文盲的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE][ICON_PRODUCTION]產能成本和[ICON_CITIZEN]人口需求會根據您擁有的城市數量而增加.'
...
-- Circus Maximus
UPDATE Language_en_US
SET Text = '提供 2 [ICON_RES_HORSE]馬匹.城市在"敬王之日"期間 +10% [ICON_CULTURE]文化和[ICON_GOLD]金幣.[NEWLINE][NEWLINE]帝國所有的競技場獲得 +2 [ICON_GOLD]金幣. -1 來自[ICON_CULTURE]文化乏味的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE][ICON_PRODUCTION]產能成本和[ICON_CITIZEN]人口需求會根據您擁有的城市數量而增加.'
WHERE Tag = 'TXT_KEY_BUILDING_CIRCUS_MAXIMUS_HELP';

UPDATE Language_en_US
SET Text = '這個國家奇跡提供 +2 [ICON_HAPPINESS_1]快樂, 2 [ICON_RES_HORSE]馬匹, +1 [ICON_CULTURE]文化,和減少[ICON_HAPPINESS_3]文化乏味, 和城市在"敬王之日"期間 +10% [ICON_CULTURE]文化和[ICON_GOLD]金幣. 城市必須已擁有競技場.'
...
UPDATE Language_en_US
SET Text = '此城市附近所有的奢侈品資源翻倍. 進來的[ICON_INTERNATIONAL_TRADE]貿易路綫產出 +4 [ICON_GOLD]金幣給城市,和+2 [ICON_GOLD]金幣給[ICON_INTERNATIONAL_TRADE]貿易路綫擁有者. 此城市的貿易路線的資源多樣性修正增加 25%. 所有城市 -1 來自[ICON_GOLD]貧窮的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE][ICON_PRODUCTION]產能成本和[ICON_CITIZEN]人口需求會根據您擁有的城市數量而增加.'
...
UPDATE Language_en_US
SET Text = '一個[ICON_GREAT_SCIENTIST]大科學家出現在城市附近. 每次完成一個科技時 +50 [ICON_CULTURE]文化, 隨時代遞增. 包含 2 文學[ICON_VP_GREATWRITING]巨作的席位. -1 來自[ICON_RESEARCH]文盲的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE][ICON_PRODUCTION]產能成本和[ICON_CITIZEN]人口需求會根據您擁有的城市數量而增加.[NEWLINE][NEWLINE]如果[COLOR_POSITIVE_TEXT]主題獎勵已啟動[ENDCOLOR] +4 [ICON_RESEARCH]科學.'
...
-- Grand神廟
UPDATE Language_en_US
SET Text = '所有的神廟獲得 +2 [ICON_PEACE]信仰和+1 [ICON_GOLD]金幣. 此城市 -2 來自宗教動亂的[ICON_HAPPINESS_3]不滿,所有其他城市 -1.[NEWLINE][NEWLINE][ICON_PRODUCTION]產能成本和[ICON_CITIZEN]人口需求會根據您擁有的城市數量而增加.'
...
-- Statue of Zeus
UPDATE Language_en_US
SET Text = '完成建造的城市,提供一個[COLOR_POSITIVE_TEXT]無償的[ENDCOLOR]軍營. 所有的軍事單位攻擊[COLOR_POSITIVE_TEXT]城市[ENDCOLOR]獲得 +25% [ICON_STRENGTH]戰鬥力. 工人不會因為被俘虏而降低改良率. 此城市 -1 來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫的[ICON_HAPPINESS_3]不滿.'
...
--神廟 of Artemis
UPDATE Language_en_US
SET Text = '完成建造的城市提供一個[COLOR_POSITIVE_TEXT]無償的[ENDCOLOR]草藥館. 所有城市 +10% [ICON_FOOD]食物. 此城市 +25% 遠程單位的[ICON_PRODUCTION]產能. 此城市 2 專家不再產生來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿 .'
...
-- Parthenon
UPDATE Language_en_US
SET Text = '此城市 +10% 來自人口的[ICON_SILVER_FIST]軍事單位供應上限. 包含一個預置的藝術[ICON_VP_GREATART]巨作以及對應的[ICON_GREAT_WORK]巨作席位. 擁有的所有的圓形劇場獲得 +1 [ICON_CULTURE]文化和+1 [ICON_RESEARCH]科學. 此城市 -1 來自[ICON_CULTURE]文化乏味的[ICON_HAPPINESS_3]不滿. 如果[COLOR_POSITIVE_TEXT]主題獎勵已啟動[ENDCOLOR] +3 [ICON_CULTURE]文化.'
WHERE Tag = 'TXT_KEY_WONDER_PARTHENON_HELP';

-- Oracle
UPDATE Language_en_US
SET Text = '為完成建造的城市提供一個[COLOR_POSITIVE_TEXT]無償的[ENDCOLOR]神廟. 立即獲得 400 [ICON_CULTURE]文化和[ICON_RESEARCH]科學. 此城市 -1 來自[ICON_RESEARCH]文盲的[ICON_HAPPINESS_3]不滿.'
...
-- Kremlin
UPDATE Language_en_US
SET Text = '需要[COLOR_MAGENTA]秩序[ENDCOLOR]政策. +33% [COLOR_POSITIVE_TEXT]裝甲單位[ENDCOLOR][ICON_PRODUCTION]產能. 1 無償的社會政策. 此城市 -1 來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫的[ICON_HAPPINESS_3]不滿.'
...
-- Forbidden Palace
UPDATE Language_en_US
SET Text = '需要完成[COLOR_MAGENTA]進步[ENDCOLOR]政策分支. 所有城市[ICON_GOLD]金幣購買的成本降低 15%. 此城市 -1 來自[ICON_GOLD]貧窮的[ICON_HAPPINESS_3]不滿.'
WHERE Tag = 'TXT_KEY_WONDER_FORBIDDEN_PALACE_HELP';

-- Globe Theatre
UPDATE Language_en_US
SET Text = '獲得 1 [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR][ICON_GREAT_WRITER]大作家. 所有城市的[ICON_VP_WRITER]作家, [ICON_VP_ARTIST]藝術家,和[ICON_VP_MUSICIAN]音樂家獲得 +2 [ICON_GOLDEN_AGE]黃金時代點數. 包含 2 文學[ICON_VP_GREATWRITING]巨作的席位. 此城市 -1 來自[ICON_CULTURE]文化乏味的[ICON_HAPPINESS_3]不滿. 所有城市 1 專家不再產出來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿. 如果[COLOR_POSITIVE_TEXT]主題獎勵已啟動[ENDCOLOR] +10 [ICON_GOLD]金幣.'
WHERE Tag = 'TXT_KEY_WONDER_GLOBE_THEATER_HELP';

-- Uffizi
UPDATE Language_en_US
SET Text = '完成建造的城市獲得 1 [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR][ICON_GREAT_ARTIST]大藝術家和一個[COLOR_POSITIVE_TEXT]無償的[ENDCOLOR]藝廊. 所有城市 +1 來自[ICON_GREAT_WORK]巨作的[ICON_CULTURE]文化. 包含 3 藝術[ICON_GREAT_WORK]巨作或文物的席位. 所有城市 1 專家不再產出來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿. 如果[COLOR_POSITIVE_TEXT]主題獎勵已啟動[ENDCOLOR] +10 [ICON_CULTURE]文化.'
...
-- Porcelain Tower
UPDATE Language_en_US
SET Text = '獲得 1 [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR][ICON_GREAT_SCIENTIST]大科學家. 完成建造的城市 +10% [ICON_RESEARCH]科學. 此城市 -1 來自[ICON_RESEARCH]文盲的[ICON_HAPPINESS_3]不滿.'
...
UPDATE Language_en_US
SET Text = '需要完成[COLOR_MAGENTA]治國[ENDCOLOR]政策分支. 獲得 1 [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR][ICON_GREAT_MERCHANT]大商業家, 和原本世界中每 4 [ICON_CITY_STATE]城邦授予 1 [COLOR_POSITIVE_TEXT]額外的[ENDCOLOR]世界大會[ICON_DIPLOMAT]代表. 此城市 -1 來自[ICON_GOLD]貧窮的[ICON_HAPPINESS_3]不滿.'
WHERE Tag = 'TXT_KEY_WONDER_BIG_BEN_HELP';

-- Neuschwanstein
UPDATE Language_en_US
SET Text = '只有城市 2 單元格領土内有山嶽才能建造. 每個城堡 +1 [ICON_GOLD]金幣, [ICON_CULTURE]文化,和[ICON_HAPPINESS_1]快樂.'
...
-- Prora
UPDATE Language_en_US
SET Text = '需要 [COLOR_MAGENTA]獨裁[ENDCOLOR]政策和只能在沿海城市建造. 獲得 1 [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR]社會政策. 每采用 2 政策[ICON_CAPITAL]首都 +1 [ICON_HAPPINESS_1]快樂. 己方單位掠奪單元格獲得 25 [ICON_CULTURE]文化, 隨時代遞增.'
