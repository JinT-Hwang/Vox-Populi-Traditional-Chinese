...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]自由貿易[ENDCOLOR][NEWLINE][ICON_BULLET]獲取[ICON_GREAT_MERCHANT]大商業家加快 50%.[NEWLINE][ICON_BULLET][ICON_INTERNATIONAL_TRADE]國際貿易路線 +5 [ICON_GOLD]金幣.[NEWLINE][ICON_BULLET]所有城市 -2 來自[ICON_GOLD]貧窮的[ICON_HAPPINESS_3]不滿度 from  in all Cities.'
