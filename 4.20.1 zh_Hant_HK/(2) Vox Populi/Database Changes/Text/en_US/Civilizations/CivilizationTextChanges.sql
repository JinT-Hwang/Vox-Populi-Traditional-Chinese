...
UPDATE Language_ZH_HANT_HK
SET Text = '{TXT_KEY_UNIT_AMERICAN_MINUTEMAN}是美國獨有的單位，取代了{TXT_KEY_UNIT_MUSKETMAN}。它可以在複雜地形中移動而不會受到懲罰，並且可以從摧毀單位中獲得[ICON_GOLDEN_AGE]黃金時代點數。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '+5% 來自人口的[ICON_SILVER_FIST]軍事單位供應上限。+1 [ICON_RANGE_STRENGTH]城市攻擊距離。大科學家被用來研發新科技時，多提供 5% [ICON_RESEARCH]科學。[NEWLINE][NEWLINE]此城市的[ICON_CITY_STATE]帝國規模修正減少 5%。'
...
--------------------
UPDATE Language_ZH_HANT_HK
SET Text = '「敬王之日」成為嘉年華會，-50% 來自需求的[ICON_HAPPINESS_3]不滿度。[ICON_GOLDEN_AGE]黃金時代開始時，30% [ICON_GOLDEN_AGE]黃金時代點數轉換爲[ICON_GOLD]金幣和[ICON_TOURISM]旅遊業績，城市獲得 10 回合的嘉年華會。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '近戰和火器部隊可以招募擊敗的敵人，這不會消耗[ICON_WAR]軍隊上限。每 10 軍事單位，所有城市 +1 [ICON_CULTURE]文化和[ICON_TOURISM]旅遊業績。+15% 來自人口的[ICON_SILVER_FIST]軍事單位供應上限。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '每個[ICON_CITY_STATE]城邦朋友使[ICON_CAPITAL]首都 +2 [ICON_RESEARCH]科學，并且每個盟友額外 +2 [ICON_CULTURE]文化，隨時代而遞增。每個禮物單位每回合獲得 +1 [ICON_INFLUENCE]影響力給[ICON_CITY_STATE]城邦(被殺時丟失)。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '獨有的德國 {TXT_KEY_BUILDING_MINT} 的取代品。除了 {TXT_KEY_BUILDING_MINT} 的獎勵外，{TXT_KEY_BUILDING_HANSE_DESC} 產出更多的[ICON_GOLD]金幣和[ICON_CULTURE]文化；甚至提升[ICON_INTERNATIONAL_TRADE]國際貿易路綫；基於城市的[ICON_CULTURE]金幣產量產出[ICON_RESEARCH]科；并且提供一個[ICON_PRODUCTION]產能加成取決於你的[ICON_INTERNATIONAL_TRADE]貿易路綫連接到城邦的數量。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '{TXT_KEY_UNIT_INCAN_SLINGER} 是印加獨有的單位，取代 {TXT_KEY_UNIT_VP_SLINGER}。它擁有優越的射程，並能使敵方單位迷亂，從而降低其[ICON_STRENGTH]戰鬥力很長一段時間。[NEWLINE][NEWLINE]使用它來騷擾您的敵人，並快速攻下蠻族陣營。'
...
--------------------
UPDATE Language_ZH_HANT_HK
SET Text = '當你進入古典，文藝復興，現代和資訊時代時，獲得 1 [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR]社會政策，并且之後的每個時代也如此。當您第一次採用一種意識形態時，獲得 2 額外的[COLOR_POSITIVE_TEXT]無償的[ENDCOLOR]原則。'
WHERE Tag = 'TXT_KEY_TRAIT_SOLIDARITY';

UPDATE Language_ZH_HANT_HK
SET Text = '提供 1 [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR][ICON_RES_HORSE]馬匹。建造騎乘近戰單位時 +50% [ICON_PRODUCTION]產能和 +15 經驗。+1 [ICON_WAR]軍事單位供應上限。此城市出發的國内[ICON_INTERNATIONAL_TRADE]貿易路綫 +2 [ICON_PRODUCTION]產能。[NEWLINE][NEWLINE]附近的[ICON_RES_HORSE]馬匹：+3 [ICON_PRODUCTION]產能，+3 [ICON_GOLD]金幣。[NEWLINE]附近的[ICON_RES_SHEEP]羊群：+3 [ICON_PRODUCTION]產能，+3 [ICON_GOLD]金幣。[NEWLINE]附近的[ICON_RES_COW]牛群：+3 [ICON_PRODUCTION]產能，+3 [ICON_GOLD]金幣。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '陸地近戰單位[COLOR_POSITIVE_TEXT]攻擊時[ENDCOLOR]獲得 +20% [ICON_STRENGTH]戰鬥力，并且攻城單位獲得 +1 [ICON_MOVES]移動力。當一個[ICON_GREAT_GENERAL]大將軍誕生時，所有陸上軍事單位恢復滿血和獲得 +15 經驗。+15% [ICON_GREAT_GENERAL]/[ICON_GREAT_ADMIRAL][COLOR_POSITIVE_TEXT]領導力[ENDCOLOR]戰鬥加成。'
