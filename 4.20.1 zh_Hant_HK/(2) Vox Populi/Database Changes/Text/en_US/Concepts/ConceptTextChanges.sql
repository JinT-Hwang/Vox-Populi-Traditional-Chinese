...
UPDATE Language_ZH_HANT_HK
SET Text = '有[COLOR_YELLOW]十種[ENDCOLOR]類型的偉人: 大藝術家、大音樂家、大作家、大工程師、大商業家、大科學家、[COLOR_YELLOW]大外交官[ENDCOLOR]、大將軍、海軍上將和大預言家。前七種類型的功能相當類似，每個類型都有與其專業領域相關的能力，而大將軍，海軍上將和大預言家則相當不同:它們的產生方式不同，對遊戲的影響也不同。大將軍和海軍上將提供陸戰和海戰相關的加成，而大預言家則允許您建立宗教。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_CYAN]大作家、藝術家、音樂家、工程師、科學家、商業家和外交官[ENDCOLOR] 是由專家和奇跡在城市中創造出來的，他們會產生「偉人」(GP) 點數。每個城市的 GP 點數都是單獨記錄的，不同類型的偉人的點數不會匯集在一起。[NEWLINE][NEWLINE]當一個城市有足夠特定類型的偉人點數時，點數會被用來產生該類型的偉人。其他城市的偉人點數不會消耗。一旦產生偉人，玩家所有城市中下一個偉人所需的點數就會增加。有些建築和政策會增加您產生偉人的速度。[NEWLINE][NEWLINE][COLOR_CYAN]大將軍和海軍上將[ENDCOLOR]的產生方式與其他偉人有些不同。大將軍和海軍上將並非由專家在城市中產生，而是透過戰鬥產生。每當您的陸地單位獲得 XP 時，您的文明會產生大將點數 (與蠻族對戰時除外)。每當您的一個航海單位獲得 XP 時，您的文明就會產生大將軍點數。當您有足夠的點數時，您就可以獲得一位偉人，而下一位偉人所需的點數也會增加。[NEWLINE][NEWLINE][COLOR_CYAN]大預言家[ENDCOLOR]是收集[ICON_PEACE]信仰的結果，也是唯一可以建立或強化宗教的單位。一旦您累積了足夠的[ICON_PEACE]信仰(在標準速度遊戲中至少 [COLOR_YELLOW]800[ENDCOLOR])，就會出現一位大預言家。接下來的每一位大預言家所需要的[ICON_PEACE]信仰數量都會增加。[COLOR_YELLOW]您收到的第一個大預言家會在首都產生，接下來的大預言家會在您的聖城產生。[ENDCOLOR]到了工業時代之後，大預言家不再是自動產生的，而是可以在城市裡用信仰購買。[NEWLINE][NEWLINE]此外，當您進入工業時代後，您就可以消耗未使用的「信仰」來購買「偉人」，這取決於您[COLOR_YELLOW]已完成[ENDCOLOR]的社會政策分支。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_CYAN]特殊改良設施：學院[ENDCOLOR][NEWLINE]你可以消耗大科學家來建立學院。当市民工作时，學院會為您的城市帶來很大的科學助力。[NEWLINE][NEWLINE][COLOR_CYAN]特殊能力：{TXT_KEY_MISSION_DISCOVER_TECH}[ENDCOLOR][NEWLINE]您可以消耗您的大科學家立即獲得一次性的科學。[COLOR_YELLOW]您所創造和擁有的每一個學院，都會增加 10% 的科學收益。[ENDCOLOR]'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_CYAN]特殊改良設施：製造廠[ENDCOLOR][NEWLINE]您可以消耗一個大工程師來創造一個製造廠。如果市民工作，它會為城市生產大量的產能(錘)，並且相鄰的每個類型的改良設施也有加成。[NEWLINE][NEWLINE][COLOR_CYAN]特殊能力：{TXT_KEY_MISSION_HURRY_PRODUCTION}[ENDCOLOR][NEWLINE]您可以消耗一個大工程師來加快該城市當前的生產。[COLOR_YELLOW]產能的數量等於最佳城市最近平均產出的五個回合。您創建並擁有的每個自有製造廠都會增加 10%。[ENDCOLOR]'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_CYAN]特殊能力：戰鬥加成[ENDCOLOR][NEWLINE]大將軍為 2 格內的所有友方陸地單位提供 15% 戰鬥加成。這個戰鬥加成適用於所有形式的陸地戰鬥：近戰、遠程、防禦等等。[NEWLINE][NEWLINE][COLOR_CYAN]特殊能力：{TXT_KEY_MISSION_CULTURE_BOMB}[ENDCOLOR][NEWLINE]您可以消耗大將軍來放置一個要塞，這會讓您擁有所有相鄰的單元格，因為您的文化邊界會擴大到包圍要塞。此外，要塞會為任何佔領它的單位提供很大的防禦加成。此外，它會傷害任何在要塞旁邊結束回合的敵方單位(傷害不會與其他改良設施疊加)。請注意，要塞只有在您的領土內才會運作。如果它在附近的城市被攻陷時易手，它只對新的擁有者有效。如果新的文化邊界佔有其他文明已經擁有的單元格，您會因此受到外交懲罰。當放置一座要塞時，大將軍會被消耗，[COLOR_YELLOW]而您的軍事單位供應上限會增加 1。[ENDCOLOR]'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_CYAN]特殊能力：{TXT_KEY_MISSION_FOUND_RELIGION}[ENDCOLOR][NEWLINE]如果您還沒有建立宗教，而且還有宗教待建立，您可以使用大預言家建立宗教，並為其選擇宗教信條。建立宗教的城市將會皈依您的新宗教。大預言家這樣使用時會消耗。[NEWLINE][NEWLINE][COLOR_CYAN]特殊能力：{TXT_KEY_MISSION_ENHANCE_RELIGION}[ENDCOLOR][NEWLINE]您可以使用大預言家來增強您的宗教信仰，增加兩個宗教信條。大預言家這樣使用時會消耗。[NEWLINE][NEWLINE][COLOR_CYAN]特殊改良設施：大預言家可以建造特殊的聖地改良，当市民工作时，會產生額外的[ICON_PEACE]信仰。大預言家這樣使用時會消耗。[NEWLINE][NEWLINE][COLOR_CYAN]特殊能力：{TXT_KEY_MISSION_SPREAD_RELIGION}[ENDCOLOR][NEWLINE]大預言家可以傳播您的宗教 4 次，同時消除目標城市的所有外來壓力。大預言家這樣使用時會消耗。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '每個偉人類型可消耗用於在您的文明邊界內的單元格上建造一個特殊改良設施。特殊改良設施的效果取決於創造它的偉人 - 例如，大工程師的特殊改良設施會產出產能，而大商業家的特殊改良設施則會產出現金。[COLOR_YELLOW]隨著遊戲的進行，特殊改良的產量會隨著科技、政策、建築和信條而增加。[ENDCOLOR][NEWLINE][NEWLINE]特殊改良設施必須經過市民工作才能產生任何效果。此外，特殊改良設施可以像其他改良設施一樣被掠奪和修繕。如果建造在資源之上，只有當該資源是戰略資源時，特殊改良設施才會提供該資源。[NEWLINE][NEWLINE]請注意，您必須將偉人走出城市，並走入您的領土，才能建造特殊改良設施。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '您可以消耗一個大商業家來創造一個城鎮。當市民工作時，城鎮每回合會為城市產生大量黃金和食物，並增加來自大商業家貿易任務的「敬王之日」時間。[NEWLINE][NEWLINE]如果城鎮建在連接兩個己方城市的道路或鐵路上，會獲得額外的[ICON_GOLD]金幣和[ICON_PRODUCTION]產能。[NEWLINE][NEWLINE]如果有國內或國際貿易路線經過此城鎮，會獲得額外的[ICON_GOLD]金幣和[ICON_PRODUCTION]產能 (工業時代前 +1，工業時代或之後 +2)。'
...
[NEWLINE][ICON_BULLET]與玩家分享您的宗教[COLOR_YELLOW]([COLOR_POSITIVE_TEXT]+X%[COLOR_YELLOW]，其帝國內信徒的百分比，最大值 [COLOR_POSITIVE_TEXT]+50%[COLOR_YELLOW])[ENDCOLOR]。
...
UPDATE Language_ZH_HANT_HK
SET Text = '蠻族營寨幾乎可以製造遊戲中所有種類的單位 - 從戰士和長矛手到加農炮和坦克。(他們可以建造與最先進文明相等的單位)。[NEWLINE][NEWLINE]蠻族單位一旦建立，就會在他們的營地附近徘徊，或是前往最近的文明或城邦嘗試製造麻煩。他們會攻擊單位、摧毀改良設施和威脅城市。[COLOR_YELLOW]在沒有駐軍的城市旁邊的蠻族可以從擁有者那裡偷取食物、文化、生產或科學。他們也可以征服防禦不佳的城市，將其變成蠻族城市。[ENDCOLOR][NEWLINE][NEWLINE]這就是為什麼要定期掃蕩您的文明周圍的郊區，在他們成為威脅之前摧毀他們的營地。'
WHERE Tag = 'TXT_KEY_BARBARIAN_UNITS_HEADING2_BODY';

UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_YELLOW]經驗值限制[ENDCOLOR]'
WHERE Tag = 'TXT_KEY_BARBARIAN_POINTLIMITS_HEADING3_TITLE';
UPDATE Language_ZH_HANT_HK
SET Text = '當他們與蠻族單位作戰時，你訓練欠佳的單位將獲得經驗。 然而，任何已經獲得 [COLOR_YELLOW]45 經驗[ENDCOLOR]（或已將這麼多經驗換成升級）的單位將不再從與蠻族單位戰鬥中獲得經驗。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_YELLOW]敬王之日[ENDCOLOR]'
...
UPDATE Language_ZH_HANT_HK
SET Text = '如果一個城市有道路或[COLOR_YELLOW]沿著相同的河流（包括經由湖泊）和/或有燈塔相連（即兩個城市都有燈塔）[ENDCOLOR]，該城市就與首都有城市連線。每個「城市連線」每回合都有一定數量的金幣，數量由兩個城市的規模決定。[NEWLINE][NEWLINE][COLOR_GREEN]如果一個城市有鐵路或海運碼頭與您的首都城市相連(即兩個城市都有海運碼頭)，則該城市與首都有工業城市連線。工業城市連線會給予目標城市生產額外的加成，數額由兩個城市的規模決定。工業城市連線也允許興建煤炭站，工業時代的建築會為城市帶來大量的生產加成。[ENDCOLOR]'
...
UPDATE Language_ZH_HANT_HK
SET Text = '您可以花費金幣購買單位 [COLOR_YELLOW]或是投資城市中的建築物[ENDCOLOR]。點選一個單位 (如果您負擔得起的話！)，它會立即在城市裡訓練，並從您的金庫裡扣除金額。[COLOR_YELLOW]如果您點選建築物，就會投資在該建築物上，降低該建築物 50% 的生產成本，如果是奇蹟則降低 25%。[ENDCOLOR][NEWLINE][NEWLINE]請注意「計畫」- 曼哈頓計畫等。- 不能購買。[NEWLINE][NEWLINE][COLOR_YELLOW]單位和建築物的購買成本會隨著您研究的科技數量略有增加。[ENDCOLOR]'
