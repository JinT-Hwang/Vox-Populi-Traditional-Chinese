...
1.从上方的英文原版地址下载 4.21 版本 exe, 或者使用附带的.


2.将游戏语言设置为繁体. 


3.运行 Vox.Populi.4.21.exe 进行安装. (根据需要进行安装 CP 或 VP, 以及是否使用EUI)


4.将 "Vox Populi 4.21 Traditional Chinese (v 10)" 文件夹, 放置到
...
在 C:\Users\你的用户名\Documents\My Games\Sid Meier's Civilization 5\MODS\Vox Populi 4.21 Traditional Chinese (v 10) 文件夹下,
...
1.汉化文本为繁体, 只针对版本 4.21 需注意, 游戏若非繁体中文, 可能会因为字体不支持繁体而不能显示文本. 
