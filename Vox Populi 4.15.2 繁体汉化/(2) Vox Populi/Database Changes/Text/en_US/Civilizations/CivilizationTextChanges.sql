...
UPDATE Language_en_US
SET Text = '城市每 5 [ICON_CITIZEN]公民 +1 [ICON_FOOD]食物. 此城市 +33% [ICON_GREAT_PEOPLE]偉人誕生速度. 15% 的[ICON_FOOD]食物在新[ICON_CITIZEN]公民誕生后保留.[NEWLINE][NEWLINE]每回合 10% 此城市的[ICON_CULTURE]文化轉化為[ICON_RESEARCH]科學 .[NEWLINE][NEWLINE]-1 來自[ICON_GOLD]貧窮的[ICON_HAPPINESS_3]不滿.'
...
--------------------
UPDATE Language_en_US
SET Text = '"敬王之日"成為嘉年華會, -50% 來自需求的[ICON_HAPPINESS_3]不滿. [ICON_GOLDEN_AGE]黃金時代開始時, 30% [ICON_GOLDEN_AGE]黃金時代點數轉換爲[ICON_GOLD]金幣和[ICON_TOURISM]旅遊業績, 城市獲得 10 回合的嘉年華.'
...
UPDATE Language_en_US
SET Text = '登船單位獲得 +1 [ICON_MOVES]移動力和僅付出 1 [ICON_MOVES]移動力就可登船或登陸. [COLOR_POSITIVE_TEXT]掠奪[ENDCOLOR]時, 陸軍和海軍近戰單位獲得更多生命和[ICON_GOLD]金幣,對鄰近的敵人造成 10 點傷害,並且不消耗[ICON_MOVES]移動力.'
...
UPDATE Language_en_US
SET Text = '{TXT_KEY_UNIT_DANISH_BERSERKER} 是丹麥獨有的單位,取代 {TXT_KEY_UNIT_PIKEMAN}. 它可以越過河流,並在登船狀態時進行攻擊而不會受到懲罰,而且對受傷的單位有 [ICON_STRENGTH]戰鬥力加成.它的速度也更快,讓它可以追上受傷的單位,進行最後一擊. 它在[COLOR_CYAN]古典時代[ENDCOLOR]發現[COLOR_CYAN]{TXT_KEY_TECH_METAL_CASTING_TITLE}[ENDCOLOR]后可用, 比 {TXT_KEY_UNIT_PIKEMAN} 更早.'
...
UPDATE Language_en_US
SET Text = '海軍和登船單位 +1 [ICON_MOVES]移動力, 和 -25% 海軍單位的[ICON_GOLD]維護費. 所有己方城市 +15 [ICON_SPY]城市安保. [ICON_SPY]間諜可在 1 個回合內前往任何城市,並在異國城市中增強 25%.開始即有一個[ICON_SPY]間諜.'
...
UPDATE Language_en_US
SET Text = '當您獲得一座城市時, 3 獨特的奢侈品中的一個([ICON_RES_CLOVES]/[ICON_RES_PEPPER]/[ICON_RES_NUTMEG])會出現在附近. +5% 來自[ICON_VP_MONOPOLY]全球壟斷的產量和[ICON_GOLDEN_AGE]黃金時代時期修正; +2 [ICON_VP_MONOPOLY]全球壟斷的產量和[ICON_HAPPINESS_1]快樂.'
WHERE Tag = 'TXT_KEY_TRAIT_SPICE';

UPDATE Language_en_US
SET Text = '建造完成時, 一個[ICON_RES_CLOVES]丁香, [ICON_RES_PEPPER]胡椒,或者[ICON_RES_NUTMEG]肉荳蔻資源會出現在城市附近.[NEWLINE][NEWLINE]此城市 +25% [ICON_GREAT_PEOPLE]偉人誕生速度. "敬王之日"期間城市 +15% [ICON_CULTURE]文化和[ICON_PEACE]信仰.[NEWLINE][NEWLINE]城市 1 專家不再產生來自[ICON_URBANIZATION]城市化的[ICON_HAPPINESS_3]不滿.[NEWLINE][NEWLINE]附近的綠洲: +2 [ICON_GOLD]金幣.[NEWLINE]附近的[ICON_RES_CITRUS]柑橘: +1 [ICON_FOOD]食物, +1 [ICON_GOLD]金幣.[NEWLINE]附近的[ICON_RES_COCOA]可可: +1 [ICON_FOOD]食物, +1 [ICON_GOLD]金幣.[NEWLINE]附近的[ICON_RES_CLOVES]丁香: +1 [ICON_PEACE]信仰, +1 [ICON_CULTURE]文化.[NEWLINE]附近的[ICON_RES_PEPPER]胡椒: +1 [ICON_PEACE]信仰, +1 [ICON_GOLD]金幣.[NEWLINE]附近的[ICON_RES_NUTMEG]肉荳蔻: +1 [ICON_CULTURE]文化, +1 [ICON_PRODUCTION]產能.'
...
UPDATE Language_en_US
SET Text = '只能建造在濕地單元格或無特徵的湖/沿海單元格上, 相鄰的之間至少 3 陸地單元格. 圩田建於水面單元格可由陸地單位穿越,無需登船,就像陸上單元格一樣.'
...
UPDATE Language_en_US
SET Text = '城市每 3 [ICON_CITIZEN]公民 +1 [ICON_GOLD]金幣. 城市的[ICON_VP_SCIENTIST]科學家, [ICON_VP_ENGINEER]工程師和[ICON_VP_MERCHANT]商人專家 +1 [ICON_GOLD]金幣.[NEWLINE][NEWLINE]消除[ICON_OCCUPIED]占領城市帶來的額外的[ICON_HAPPINESS_4]不滿.'
...
--------------------
UPDATE Language_en_US
SET Text = '登船時 +2 [ICON_VP_VISION]視野, 可以隨時登陸和橫越海洋. 漁船和環礁 +2 [ICON_PRODUCTION]產能. 近戰和火器單位可以建造漁船. 與世隔絕不會產生[ICON_HAPPINESS_3]不滿.'
...
--------------------
UPDATE Language_en_US
SET Text = '對[ICON_CITY_STATE]城邦 +30% [ICON_STRENGTH]戰鬥力. 被征服的城邦會像[COLOR_POSITIVE_TEXT]盟友[ENDCOLOR]一樣提供獎勵, [ICON_HAPPINESS_1]快樂和單位禮物. [ICON_CAPITAL]首都已存在的建築 +15% [ICON_PRODUCTION]產能.'
...
--------------------
UPDATE Language_en_US
SET Text = '來自友好和盟友關係的[ICON_CITY_STATE]城邦提供雙倍產出, 資源, [ICON_HAPPINESS_1]快樂和單位禮物.'
WHERE Tag = 'TXT_KEY_TRAIT_CITY_STATE_BONUSES';

UPDATE Language_en_US
SET Text = '此城市的神廟和神龕 +3 [ICON_RESEARCH]科學. 從這個城市出發的單位所進行的外交任務 +10 [ICON_INFLUENCE]影響力.[NEWLINE][NEWLINE]+25 [ICON_SPY]城市安保, 城市每 2 [ICON_CITIZEN]公民 +1.[NEWLINE][NEWLINE]-1 來自[ICON_FOOD]和[ICON_PRODUCTION]窮迫的[ICON_HAPPINESS_3]不滿.'
...
--------------------
UPDATE Language_en_US
SET Text = '[COLOR_NEGATIVE_TEXT]無法建立開拓者或傀儡城市.[ENDCOLOR]雙倍[ICON_INTERNATIONAL_TRADE]貿易路綫上限, 移除目標限制. [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR] {TXT_KEY_UNIT_VENETIAN_MERCHANT} 來自發現 [COLOR_CYAN]{TXT_KEY_TECH_HORSEBACK_RIDING_TITLE}[ENDCOLOR]. [ICON_PUPPET]傀儡有 -30% 產量損失,可以使用 [ICON_GOLD]金幣,並像一般城市一樣獲得 [ICON_HAPPINESS_1]快樂.'
...
UPDATE Language_en_US
SET Text = '此城市訓練的所有近戰和火器單位獲得 [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_IKLWA}[ENDCOLOR]晉升. 所有單位 +15 經驗. +2 [ICON_WAR]軍隊供應上限.[NEWLINE][NEWLINE]-1 來自[ICON_FOOD]和[ICON_PRODUCTION]窮迫的[ICON_HAPPINESS_3]不滿 .'
