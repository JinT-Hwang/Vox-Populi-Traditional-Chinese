...
-- Stable
UPDATE Language_ZH_HANT_HK
SET Text = '+33% 騎乘近戰單位[ICON_PRODUCTION]產能。+1 [ICON_WAR]軍事單位供應上限。此城市的國内[ICON_INTERNATIONAL_TRADE]貿易路綫產出 +2 [ICON_PRODUCTION]產能。[NEWLINE][NEWLINE]附近[ICON_RES_HORSE]馬匹：+2 [ICON_PRODUCTION]產能。[NEWLINE]附近[ICON_RES_SHEEP]羊群：+2 [ICON_PRODUCTION]產能。[NEWLINE]附近[ICON_RES_COW]牛群：+2 [ICON_PRODUCTION]產能。[NEWLINE][NEWLINE]城市中必須至少有一個牧場改善了這些資源。'
...
-- 燈塔
UPDATE Language_ZH_HANT_HK
SET Text = '海岸和海洋單元格 +1 [ICON_FOOD]食物和 +1 [ICON_GOLD]金幣。此城市的國内的[ICON_INTERNATIONAL_TRADE]貿易路綫產出 +4 [ICON_FOOD]食物。[NEWLINE][NEWLINE]其他城市如果有燈塔，則會通過水上形成[ICON_CONNECTED]城市連接。[NEWLINE][NEWLINE]只能在沿海城市建造。'
...
-- Harbor
UPDATE Language_ZH_HANT_HK
SET Text = '完成一條從此城市出發連接到其他文明的[ICON_CARGO_SHIP]海上貿易路綫，會觸發一個 (或者强化現有的) [COLOR_POSITIVE_TEXT]歷史事件[ENDCOLOR]。[NEWLINE][NEWLINE]海岸和海洋單元格 +1 [ICON_FOOD]食物，同時此城市的海洋資源 +1 [ICON_PRODUCTION]產能。[ICON_CARGO_SHIP]海上貿易路綫獲得 +50% 範圍和 +2 [ICON_GOLD]金幣。[NEWLINE][NEWLINE]海軍單位 +15% [ICON_PRODUCTION]產能，同時 +1 [ICON_WAR]軍事單位供應上限。[NEWLINE][NEWLINE]只能在沿海城市建造。'
...
-- Seaport
UPDATE Language_ZH_HANT_HK
SET Text = '海岸和海洋單元格 +1 [ICON_PRODUCTION]產能和[ICON_GOLD]金幣。此城市的海岸資源 +2 [ICON_PRODUCTION]產能和[ICON_GOLD]金幣。+10% 來自人口的[ICON_SILVER_FIST]軍事單位供應上限。[NEWLINE][NEWLINE]其他城市如果有海運碼頭，則會通過水上形成[ICON_INDUSTRIAL_CONNECTED]工業城市連接。[NEWLINE][NEWLINE]只能在沿海城市建造。'
WHERE Tag = 'TXT_KEY_BUILDING_SEAPORT_HELP';

UPDATE Language_ZH_HANT_HK
SET Text = '海運碼頭是一座工業時代的建築，需要港口。水上單元格[ICON_PRODUCTION]產能和[ICON_GOLD]金幣產出，增加 10% 來自此城市人口的軍事單位供應上限。允許工業城市通過水上互連 (詳情請參閱概念)。'
...
--城堡
UPDATE Language_ZH_HANT_HK
SET Text = '所有來源對此城市傷害減少 2。此城市採石場 +1 [ICON_PRODUCTION]產能。+5% 來自人口的[ICON_SILVER_FIST]軍事單位供應上限 。包含 1 個藝術[ICON_GREAT_WORK]巨作或文物的席位。[NEWLINE][NEWLINE][ICON_CITY_STATE]此城市帝國人口修正減少 5%。'
WHERE Tag = 'TXT_KEY_BUILDING_CASTLE_HELP';

UPDATE Language_ZH_HANT_HK
SET Text = '城堡是中世紀時代的建築，可增加防禦力，並減少所有來源 2 傷害。此城市的人口可增加 5%的軍事單位上限，並增加附近所有採石場 1 的生產量。還有助於此城市的帝國人口修正管理。在建造城堡之前，城市必須已擁有城牆。'
WHERE Tag = 'TXT_KEY_BUILDING_CASTLE_STRATEGY';

-- 兵工廠
UPDATE Language_ZH_HANT_HK
SET Text = '+5% 來自人口的[ICON_SILVER_FIST]軍事單位供應上限。+1 城市的[ICON_RANGE_STRENGTH]遠程攻擊距離。[NEWLINE][NEWLINE]此城市的駐軍單位多加 5 生命治療。[NEWLINE][NEWLINE][ICON_CITY_STATE]此城市帝國人口修正減少 5%。'
WHERE Tag = 'TXT_KEY_BUILDING_ARSENAL_HELP';

UPDATE Language_ZH_HANT_HK
SET Text = '兵工廠是現代的軍事建築，可增加防禦力和攻擊力，使城市更難被攻下. 增加城市的[ICON_RANGE_STRENGTH]遠程攻擊距離 1。此城市的駐軍單位多加 5 生命治療。增加此城市的人口提供的軍事單位供應上限 5%。還有助於此城市的帝國人口修正管理。此城市必須已擁有堡壘要塞.'
WHERE Tag = 'TXT_KEY_BUILDING_ARSENAL_STRATEGY';

-- Military Base
UPDATE Language_ZH_HANT_HK
SET Text = '+25% 空軍單位[ICON_PRODUCTION]產能，空軍單位空襲城市 +15 [ICON_STRENGTH]傷害。+10% 城市的[ICON_RANGE_STRENGTH]遠程攻擊傷害。+5% 來自人口的[ICON_SILVER_FIST]軍事單位供應上限，同時此城市的駐軍單位多加 20 生命治療。[NEWLINE][NEWLINE]-1 來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫的[ICON_HAPPINESS_3]不滿度。[ICON_CITY_STATE]此城市帝國人口修正減少 5%。'
WHERE Tag = 'TXT_KEY_BUILDING_MILITARY_BASE_HELP';

UPDATE Language_ZH_HANT_HK
SET Text = '軍事基地是遊戲後期的建築，可增加防禦力和攻擊力，提高對空軍單位的防禦。此城市的駐軍單位多加 20 生命治療。增加此城市的人口所提供的軍事單位供應上限 5%。還有助於此城市的帝國人口修正管理。此城市必須已擁有兵工廠。'
...
-- Parthenon
UPDATE Language_ZH_HANT_HK
SET Text = '包含一個預置的藝術[ICON_VP_GREATART]巨作以及對應的[ICON_GREAT_WORK]巨作席位。擁有的所有的圓形劇場獲得 +1 [ICON_CULTURE]文化和+1 [ICON_RESEARCH]科學。此城市 -1 來自[ICON_CULTURE]文化乏味的[ICON_HAPPINESS_3]不滿度。如果[COLOR_POSITIVE_TEXT]主題獎勵已啟動[ENDCOLOR] +3 [ICON_CULTURE]文化。'
