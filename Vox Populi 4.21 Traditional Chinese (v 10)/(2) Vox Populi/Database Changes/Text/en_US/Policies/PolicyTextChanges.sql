...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]主權[ENDCOLOR][NEWLINE]所有城市的單元格[ICON_BULLET][ICON_CULTURE]文化成本減少 20% (指數地)。[NEWLINE][ICON_BULLET][COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_PALACE_COURT_CHAPEL}[ENDCOLOR]建造在[ICON_CAPITAL]首都(+3 [ICON_PEACE]信仰，1 藝術[ICON_GREAT_WORK]巨作或者文物席位，1 [ICON_VP_ARTIST]藝術家席位)。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]典禮[ENDCOLOR][NEWLINE][ICON_BULLET]有建築要求的國家奇觀 +1 [ICON_HAPPINESS_1]幸福度。[NEWLINE][ICON_BULLET]有建築要求的國家奇觀 +25% [ICON_PRODUCTION]產能。[NEWLINE][ICON_BULLET][COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_PALACE_ASTROLOGER}[ENDCOLOR]建造在[ICON_CAPITAL]首都(+3 [ICON_RESEARCH]科學，所有的理事會，熏製室和草藥館 +1 [ICON_RESEARCH]科學；1 [ICON_VP_SCIENTIST]科學家席位)。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]平等[ENDCOLOR][NEWLINE][ICON_BULLET]所有城市 +1 [ICON_HAPPINESS_1]幸福度和每 15 [ICON_CITIZEN]公民 +1 [ICON_HAPPINESS_1]幸福度。[NEWLINE][ICON_BULLET]所有城市 -1  來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫，[ICON_GOLD]貧窮，[ICON_RESEARCH]文盲和[ICON_CULTURE]文化乏味的[ICON_HAPPINESS_3]不滿度。'
...
-- Leader title change
UPDATE Language_ZH_HANT_HK
SET Text = '{2_CivName:textkey} 的大能者 {1_PlayerName:textkey}'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]軍國主義[ENDCOLOR][NEWLINE][ICON_BULLET]城市至少有 10 [ICON_STRENGTH]戰鬥力時 +1 [ICON_HAPPINESS_1]幸福度和 +2 [ICON_CULTURE]文化。[NEWLINE][ICON_BULLET]-15% [ICON_GOLD]單位維護費。[NEWLINE][ICON_BULLET]-50% [ICON_GOLD]路線維護費。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]支配力[ENDCOLOR][NEWLINE][ICON_BULLET]所有近戰單位獲得 [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_KILL_HEAL}[ENDCOLOR] 晉升(擊敗敵人單位後恢復 15 HP)。[NEWLINE][ICON_BULLET]帝國每 10 軍事單位，所有城市 +1 [ICON_PRODUCTION]產能。[NEWLINE][ICON_BULLET]+5 [ICON_SILVER_FIST]軍隊供應上限。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]組織化宗教[ENDCOLOR][NEWLINE][ICON_BULLET]追隨你[ICON_RELIGION]最主要的宗教的己方城市 +25% 壓力。[NEWLINE][ICON_BULLET]每 10 追隨你[ICON_RELIGION]最主要的宗教的城市 +1 世界議會的[ICON_DIPLOMAT]代表。[NEWLINE][ICON_BULLET]神龕和神廟 +2 [ICON_CULTURE]文化。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]貴族[ENDCOLOR][NEWLINE][ICON_BULLET]城堡 +1 [ICON_HAPPINESS_1]幸福度和 +2 [ICON_GOLD]金幣。[NEWLINE][ICON_BULLET]軍械庫 +2 [ICON_GOLD]金幣。[NEWLINE][ICON_BULLET]城堡和軍械庫 +100% [ICON_PRODUCTION]產能。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]君權神授[ENDCOLOR][NEWLINE][ICON_BULLET]國內[ICON_INTERNATIONAL_TRADE]貿易路線 +33% 產量。[NEWLINE][ICON_BULLET]完成一條國內[ICON_INTERNATIONAL_TRADE]貿易路線也會同國際[ICON_INTERNATIONAL_TRADE]貿易路線一樣觸發歷史事件。[NEWLINE][ICON_BULLET]所有城市 -1 來自[ICON_CULTURE]文化乏味的[ICON_HAPPINESS_3]不滿度。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]采邑[ENDCOLOR][NEWLINE][ICON_BULLET]帝國每 10 軍事單位 +1 [ICON_HAPPINESS_1]幸福度。[NEWLINE][ICON_BULLET]+15% [ICON_PRODUCTION]產能，並且[COLOR_POSITIVE_TEXT]敬王之日[ENDCOLOR]期間 +100% [ICON_CULTURE_LOCAL]邊界成長。'
...
-- Leader title change
UPDATE Language_ZH_HANT_HK
SET Text = '{2_CivName:textkey} 的{@1: gender feminine?女主人; other?主人;} {1_PlayerName:textkey}'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]領事館[ENDCOLOR][NEWLINE][ICON_BULLET]原本世界上，每 8 [ICON_CITY_STATE]城邦 +1 世界議會的[ICON_DIPLOMAT]代表。[NEWLINE][ICON_BULLET]完成一條到城邦的[ICON_INTERNATIONAL_TRADE]貿易路線會觸發(或加強已存在)的一個[COLOR_POSITIVE_TEXT]歷史事件[ENDCOLOR]。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]交易市場[ENDCOLOR][NEWLINE][ICON_BULLET]+1 [ICON_INTERNATIONAL_TRADE]貿易路線。[NEWLINE][ICON_BULLET]每條激活中的[ICON_INTERNATIONAL_TRADE]貿易路線 +1 [ICON_HAPPINESS_1]幸福度。[NEWLINE][ICON_BULLET][COLOR_POSITIVE_TEXT]貿易路線[ENDCOLOR] +15% [ICON_TOURISM]旅遊業績修正。[NEWLINE][ICON_BULLET]來自城邦的資源計入全球壟斷。'
...
-- Leader title change
UPDATE Language_ZH_HANT_HK
SET Text = '{2_CivName:textkey} 的{@1: gender feminine?女贊助人; other?贊助人;} {1_PlayerName:textkey}'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]人文主義[ENDCOLOR][NEWLINE][ICON_BULLET]文學[ICON_VP_GREATWRITING]巨作 +3 [ICON_PEACE]信仰。[NEWLINE][ICON_BULLET]觸發[ICON_GOLDEN_AGE]黃金時代 -25% 所需的[ICON_GOLDEN_AGE]黃金時代點數。[NEWLINE][ICON_BULLET]所有公會 +1 [ICON_HAPPINESS_1]幸福度。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]教養[ENDCOLOR][NEWLINE][ICON_BULLET]藝術[ICON_VP_GREATART]巨作 +2 [ICON_CULTURE]文化。[NEWLINE][ICON_BULLET]所有城市 1 專家不再產生城市化的[ICON_HAPPINESS_3]不滿度。[NEWLINE][ICON_BULLET]專家 +1 [ICON_CULTURE]文化。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]文化交流[ENDCOLOR][NEWLINE][ICON_BULLET]城市每 3 [ICON_GREAT_WORK]巨作 +1 [ICON_HAPPINESS_1]幸福度。[NEWLINE][ICON_BULLET]圓形劇場，藝廊和歌劇院 +2 [ICON_PRODUCTION]產能和[ICON_CULTURE]文化。[NEWLINE][ICON_BULLET]和其他文明[COLOR_POSITIVE_TEXT]開房邊界[ENDCOLOR] +10% [ICON_TOURISM]旅遊業績修正。'
...
-- Leader title change
UPDATE Language_ZH_HANT_HK
SET Text = '{2_CivName:textkey} 的首相 {1_PlayerName:textkey}'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]自由貿易[ENDCOLOR][NEWLINE][ICON_BULLET]獲取[ICON_GREAT_MERCHANT]大商業家加快 50%。[NEWLINE][ICON_BULLET][ICON_INTERNATIONAL_TRADE]國際貿易路線 +5 [ICON_GOLD]金幣。[NEWLINE][ICON_BULLET]所有城市 -2 來自[ICON_GOLD]貧窮的[ICON_HAPPINESS_3]不滿度.'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]企業家精神[ENDCOLOR][NEWLINE][ICON_BULLET]工作坊 +1 [ICON_HAPPINESS_1]幸福度。[NEWLINE][ICON_BULLET]礦場、採石場和鋸木廠 +2 [ICON_PRODUCTION]產能和 +1 [ICON_GOLD]金幣。[NEWLINE][ICON_BULLET]當你使用[ICON_GREAT_MERCHANT]大商業家或者[ICON_GREAT_ENGINEER]大工程師的即時產出能力並消耗時，+25% 產量。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]戒嚴令[ENDCOLOR][NEWLINE][ICON_BULLET]城市駐軍無需[ICON_GOLD]維護費。[NEWLINE][ICON_BULLET]有駐軍的城市 +1 [ICON_HAPPINESS_1]幸福度和 +4 [ICON_CULTURE]文化。[NEWLINE][ICON_BULLET][ICON_PUPPET]傀儡城市 -20% 產量懲罰。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]啟蒙運動[ENDCOLOR][NEWLINE][ICON_BULLET]收到 1 [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR]科技。[NEWLINE][ICON_BULLET]大學 +1 [ICON_HAPPINESS_1]幸福度。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]人權[ENDCOLOR][NEWLINE][ICON_BULLET]所有城市 -1 來自所有需求的[ICON_HAPPINESS_3]不滿度。[NEWLINE][ICON_BULLET]村莊 +2 [ICON_PRODUCTION]產能和[ICON_GOLD]金幣。[NEWLINE][ICON_BULLET][ICON_GOLDEN_AGE]黃金時代期間 +10% [ICON_RESEARCH]科學。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]思想自由[ENDCOLOR][NEWLINE][ICON_BULLET]所有城市 -5 來自宗教動亂的[ICON_HAPPINESS_3]不滿度。[NEWLINE][ICON_BULLET][ICON_GREAT_SCIENTIST]大科學家 +25% 即時產出。[NEWLINE][ICON_BULLET]獲取[ICON_GREAT_SCIENTIST]大科學家加快 +33%。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]資本主義[ENDCOLOR]：城市有 2 [ICON_CITIZEN]專家 +1 [ICON_HAPPINESS_1]幸福度，而不是 +1 來自城市化的[ICON_HAPPINESS_3]不滿度。專家 +1 [ICON_GOLD]金幣和[ICON_RESEARCH]科學。'
WHERE Tag = 'TXT_KEY_POLICY_CAPITALISM_HELP';

UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]前衛派[ENDCOLOR]：[ICON_GREAT_PEOPLE]偉人的誕生速度增加 33%。所有城市 -2 來自[ICON_CULTURE]文化乏味的[ICON_HAPPINESS_3]不滿度。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]媒體文化[ENDCOLOR]：有廣播塔的城市 +25% [ICON_TOURISM]旅遊業績和 +1 [ICON_HAPPINESS_1]幸福度。體育場 +20% [ICON_CULTURE]文化。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]遏制[ENDCOLOR]：[ICON_INTERNATIONAL_TRADE]每條己方的城邦貿易路線(最高到 +10)，到城邦的貿易路線每回合 +2 [ICON_INFLUENCE]影響力(給目標城邦) . 原本在世界上的每 2 [ICON_CITY_STATE]城邦 +1 世界議會的[ICON_DIPLOMAT]代表。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]普選權[ENDCOLOR]：開始一個[ICON_GOLDEN_AGE]黃金時代，並且[ICON_GOLDEN_AGE]黃金時代加長 50%。城市 +1 [ICON_HAPPINESS_1]幸福度。'
...
--------------------
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]科學院[ENDCOLOR]：所有城市 -2 來自[ICON_RESEARCH]文盲的[ICON_HAPPINESS_3]不滿度，研發實驗室 +100% [ICON_PRODUCTION]產能，並且你的帝國獲得 5 [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR]研發實驗室。研發實驗室額外 +2 [ICON_RESEARCH]科學。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]文化革命[ENDCOLOR]：對較低[ICON_HAPPINESS_1]幸福度的文明 +25% [ICON_TOURISM]旅遊業績。工廠 +1 [ICON_HAPPINESS_1]幸福度。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]無產階級專政[ENDCOLOR]：每個城市 +7 [ICON_FOOD]食物，[ICON_RESEARCH]科學，[ICON_GOLD]金幣和[ICON_CULTURE]文化。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]衛國戰爭[ENDCOLOR]：陸地單位在城市內或旁邊時 +20% [ICON_STRENGTH]戰鬥力。當你第一次征服一個城市時，城市 3 单元格內所有軍事單位恢復滿血。可以建造[COLOR_YELLOW]T-34[ENDCOLOR]。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]人民解放軍[ENDCOLOR]：軍校 +100% [ICON_PRODUCTION]產能，並且帝國收到 5 [COLOR_POSITIVE_TEXT]無償的[ENDCOLOR]軍校。公立學校 +5 [ICON_CULTURE]文化和 +2 [ICON_HAPPINESS_1]幸福度。'
...
-- Leader title change
UPDATE Language_ZH_HANT_HK
SET Text = '{2_CivName:textkey} 的領袖 {1_PlayerName:textkey}'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]新世界秩序[ENDCOLOR]：所有城市 -2 來自[ICON_FOOD]和[ICON_PRODUCTION]窘迫的[ICON_HAPPINESS_3]不滿度。警察局和軍警局 +3 [ICON_CULTURE]文化和 +5 [ICON_PRODUCTION]產能，建造加快 100%。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]警察國家[ENDCOLOR]：每個法院 +3 [ICON_HAPPINESS_1]本地幸福度，並且警察局 +10 城市安保。法院和警察局 +100% [ICON_PRODUCTION]產能。'
...
UPDATE Language_ZH_HANT_HK
SET Text = '[COLOR_POSITIVE_TEXT]共榮圈[ENDCOLOR]：霸凌[ICON_CITY_STATE]城邦不再減少[ICON_INFLUENCE]影響力，撤銷任務或取消保護承諾。這樣做會降低被霸凌的城邦的所有其他文明的[ICON_INFLUENCE]影響力 10%，並且增加你的[ICON_INFLUENCE]影響力 10%。'
