...
-- Great Engineer
UPDATE Language_ZH_HANT_HK
SET Text = '大工程師可以建造特殊的製造廠改良設施。當市民工作時，它會為城市提供大量的[ICON_PRODUCTION]產能, 相鄰的每個類型的改良設施有加成。大工程師也能加速城市中的單位、建築或奇蹟的產能，每創造和擁有一座製造廠，產能就會增加 10%。當使用以上任何一種方式時，大工程師都會消耗。'
...
-- 海軍上將
UPDATE Language_ZH_HANT_HK
SET Text = '海軍上將可以立即自由橫越海洋，使其成為有用的探索船隻 (脆弱的)。此外，當海軍上將在己方領土時，它可以被派去進行 [COLOR_POSITIVE_TEXT]探索之旅[ENDCOLOR],消耗該單位並給您兩份目前地圖上沒有的奢侈品資源複製品。[NEWLINE][NEWLINE]海軍上將可以立即[COLOR_POSITIVE_TEXT]修繕[ENDCOLOR]同一格以及鄰近格內的所有海軍和海運單位。執行此動作時，會消耗海軍上將。海軍上將也提供 +15% [ICON_STRENGTH]戰鬥力給 2 格內所有玩家擁有的海軍單位。海軍上將提供此加成時，不會被消耗。當海軍上將用於[COLOR_POSITIVE_TEXT]探索之旅[ENDCOLOR]或[COLOR_POSITIVE_TEXT]修繕[ENDCOLOR]時，它會增加你的軍事單位供應上限 1。'
